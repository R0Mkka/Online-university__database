...
CREATE TABLE IF NOT EXISTS roles (
	roleId TINYINT UNSIGNED NOT NULL AUTO_INCREMENT PRIMARY KEY,
    roleName VARCHAR(20) NOT NULL
);

CREATE TABLE IF NOT EXISTS themes (
	themeId SMALLINT UNSIGNED NOT NULL AUTO_INCREMENT PRIMARY KEY,
    themeName VARCHAR(30) NOT NULL
);

CREATE TABLE IF NOT EXISTS languages (
	languageId TINYINT UNSIGNED NOT NULL AUTO_INCREMENT PRIMARY KEY,
    languageName NVARCHAR(35) NOT NULL
);

CREATE TABLE IF NOT EXISTS account_images (
	accountImageId INT UNSIGNED NOT NULL AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS users_statuses (
	userStatusId TINYINT UNSIGNED NOT NULL AUTO_INCREMENT PRIMARY KEY,
    statusName VARCHAR(20) NOT NULL
);

CREATE TABLE IF NOT EXISTS users_entries (
	userEntryId BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
    userId INT UNSIGNED NOT NULL,
    userStatusId TINYINT UNSIGNED DEFAULT 1,
    connectionId CHAR(20) NOT NULL UNIQUE,
