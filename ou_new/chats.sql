...
CREATE TABLE IF NOT EXISTS chats_images (
	chatImageId INT UNSIGNED NOT NULL AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS chats (
    ...
    chatOwnerId INT UNSIGNED NOT NULL,
    chatImageId INT UNSIGNED,
...
CREATE TABLE IF NOT EXISTS messages (
    ...
    chatId INT UNSIGNED NOT NULL,
    userId INT UNSIGNED NOT NULL,
    userEntryId BIGINT UNSIGNED NOT NULL,
...
CREATE TABLE IF NOT EXISTS messages_statuses (
	messageStatusId BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
